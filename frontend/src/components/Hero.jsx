...
export default function Hero() {
  return (
    <div className="relative isolate pt-14">
      ...
      <div className="container-custom py-24 sm:py-32 lg:pb-40">
        <motion.div 
        ...
        >
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
            Clean Your Audio.{' '}
            <span className="text-primary-600">Slash AI Transcription Spend by 27%.</span>
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            MurmurStack scrubs your buffering pipeline and cuts LLM costs instantly. 
            Zero latency, complete accuracy, lower cost.
          </p>
